...
export const Input = (props: Props) => {
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex items-center rounded border border-solid border-border-light dark:border-border-dark px-2 mt-3 mb-4" style={errors && errors[name ? name : ""] && { border: "solid 1px red" }}>
                <input
